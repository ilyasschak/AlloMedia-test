                  ...
                  <table className="w-full my-0 align-middle text-dark border-neutral-200">
                    <thead className="align-bottom">
                      <tr className="font-semibold text-[0.95rem] text-secondary-dark">
                        ...
                        {role== "DeliveryMan" || role== "Manager"  && <th className="pb-3 text-end min-w-[100px]">Phone number</th>}
                        <th className="pb-3 text-end min-w-[100px]">TOTAL PRICE</th>
                        {role== "Manager" || role== "Client" ?<th className="pb-3 pr-12 text-end min-w-[175px]">STATUS</th> : ""}
                   ...
                   {user.role.name== "Client" ? 
                      ...
                      <button onClick={()=>{setMapOpen(true)}} className="text-gray-400 bg-gray-100 hover:text-blue-800 focus:ring-4 font-medium rounded-full text-sm px-5 py-2.5 text-center">
