                    ...
                    <tbody>
                      ...
                      <tr key={index} className="border-b border-dashed last:border-b-0 hover:bg-green-100">
                        ...
                        <td className="p-3 pr-0 gap-3 text-end flex justify-end">
                          <button onClick={toggleMap} className="text-gray-400 bg-gray-100 hover:text-blue-800 focus:ring-4 font-medium rounded-full text-sm px-5 py-2.5 text-center">
