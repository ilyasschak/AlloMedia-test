const OrdersTable = ({orders,role}) => {
  return (
    <div className="w-full">
      <div class="w-full flex flex-wrap -mx-3 mb-5 w-10/12 justify-center">
            ...
            <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
              ...
              <div class="px-9 pt-5 flex justify-between items-stretch flex-wrap min-h-[70px] pb-0 bg-transparent">
                <h3 class="flex flex-col items-start justify-center m-2 ml-0 font-medium text-xl/tight text-dark">
                  ...
                  {role == "manager" && <span class="mt-1 font-medium text-secondary-dark text-lg/normal">All Orders from our clients</span>}
                  {role == "client" && <span class="mt-1 font-medium text-secondary-dark text-lg/normal">All Orders i have made</span>}
                </h3>
