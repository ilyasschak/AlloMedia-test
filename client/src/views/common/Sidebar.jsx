...
const Sidebar = () => {
  ...
  return (
    <div id="view" class=" flex flex-row w-1/4" x-data="{ sidenav: true }">
      ...
      Dashwind<span class="text-teal-600">.</span>
          ...
          <div id="profile" class="space-y-3">
            ...
            />
            <div>
              <h2 class=" text-white font-bold text-x md:text-sm text-center">
                {user._id && <div>{user.full_name}</div>}
              </h2>
              {user._id && (
                <p class="text-x text-white text-center">{user.role.name}</p>
              )}
            </div>
          </div>
