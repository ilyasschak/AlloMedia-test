...
export default function AddMenu(){
    ...
    function submitMenu(values, { resetForm }){
        ...
        axios.post('http://localhost:3000/api/menu/insert', {
            values : values
        }).then(function(response){
            resetForm();
        }).catch(error => {
        ...
        >
            {({values}) => (
                <Form className="m-auto">
                    ...
                    {restaurants.length !== 0 ? <div className='flex flex-col'>
                    ...
                    </div> : <div className='text-red-700'>You don't have any restaurants !</div>}
